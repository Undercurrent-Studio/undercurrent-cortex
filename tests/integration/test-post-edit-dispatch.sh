...
sf="$_TEST_TMPDIR/.claude/undercurrent-state-edit-inc.local.md"
...
sf="$_TEST_TMPDIR/.claude/undercurrent-state-edit-track.local.md"
...
sf="$_TEST_TMPDIR/.claude/undercurrent-state-docs-edit.local.md"
