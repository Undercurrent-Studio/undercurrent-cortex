...
Read the decisions file at `.claude/cortex-decisions.local.md`.
...
Say: "No decisions file found at `.claude/cortex-decisions.local.md`. Start logging decisions by including `[decision]` in your prompts."
